...
import UpdateSelectedState from "./UpdateSelectedState.js";

function UpdateStateSelectState(props) {
    ...
    const onSelectClick = (row) => {
        ...
        const fetchStates = () =>{
          ...
          if(selected) {
            return (
              <>    
              <UpdateSelectedState data={row} countryIdData = {countryId} countryNameData = {countryName} />
              </>
              )
          }
          return(
...
export default UpdateStateSelectState;